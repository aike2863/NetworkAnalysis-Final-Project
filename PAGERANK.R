...
nodes.ES <- read.csv("Web_Data_Files/Final_YTH_Nodes_ES.csv") 
edges.ES <- read.csv("Web_Data_Files/Final.YTH.edges.csv")
...
write.csv(fishery.support,"YTH_Indirect_AllCommFishery.csv")
...
write.csv(birdwatch.support,"YTH_Indirect_Birdwatch.csv")
...
write.csv(wathunt.support,"YTH_Indirect_WaterfowlHunt.csv")
...
write.csv(Rfishery.support,"Species-Rank/YTH_Indirect_AllRecFishery.csv")
