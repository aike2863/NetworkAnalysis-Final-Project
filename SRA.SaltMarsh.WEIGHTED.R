...
## load ranked lists
# Eco Serv ranks
indirect <- read.csv("Species-Rank/Weighted/Indirect-Rank-by-PageRank/PageRank-Scores-Combined-W.csv")
...
ggplot() +
  ...
  ggtitle("Birdwatching and Carbon Storage WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Birdwatching and Fishery WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Birdwatching and Water Filtration WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Birdwatching and Waterfowl Hunting WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Carbon storage and Fishery WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Carbon storage and Water Filtration WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Carbon storage and Waterfowl Hunting WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Fishery and Water Filtration WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Fishery and Waterfowl Hunting WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("Water Filtration and Waterfowl Hunting WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
...
ggplot() +
  geom_ribbon(data=ribbon,aes(x=depth,ymin=min.sra,ymax=max.sra),
              fill="grey70") +
  geom_line(data=a.df,aes(x=depth,y=sra), lwd=1.25,color="blue") +
  ggtitle("All services WEIGHTED, BSQ") +
  theme_classic() +
  xlab("List Depth") +
  ylab("Sequential Rank Agreement") +
  scale_size_manual(values=c(2,1.25)) +
